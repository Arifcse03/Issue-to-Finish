...
public class HeaderEOImpl extends EntityImpl {
    ...
    protected void create(AttributeList attributeList) {
        ...
        oracle.jbo.server.SequenceImpl s =new oracle.jbo.server.SequenceImpl("MNJ_MFG_ISSUE_TO_FINISH_H_S",getDBTransaction());
    ...
    public String getSrNoString() {
        String srno = null;
        String stmt = "BEGIN :1 := mnj_mfg_doc_no_pkg.Issue_To_Finish_doc_no; end;";
