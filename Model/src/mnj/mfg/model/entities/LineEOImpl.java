...
public class LineEOImpl extends EntityImpl {
     ...
     */
    public RowIterator getInsemSizeDEO() {
        return (RowIterator)getAttributeInternal(INSEMSIZEDEO);
    }
     ...
     */
     protected void create(AttributeList attributeList) {
         ...
         oracle.jbo.server.SequenceImpl s =new oracle.jbo.server.SequenceImpl("MNJ_MFG_ISSUE_TO_FINISH_L_S",getDBTransaction());
